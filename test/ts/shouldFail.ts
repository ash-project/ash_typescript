...
const invalidUnionString = await createTodo({
  input: {
...
const directUnionTest = await createTodo({
  input: {
...
const invalidArrayUnionString = await createTodo({
  input: {
...
const invalidBothUnionStrings = await createTodo({
  input: {
