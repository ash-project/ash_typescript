...
export function testNullableMoneyAcceptsNull() {
  const validated = v.parse(createTaskValibotSchema, { title: "Free", price: null });
...
export function testNullableTypedStructAcceptsNull() {
  const validated = v.parse(updateTaskValibotSchema, { stats: null });
...
export function testUpdateTaskAllOmittable() {
  const validated = v.parse(updateTaskValibotSchema, {});
...
export function testUpdateTaskOmittableTitleAcceptsValue() {
  const validated = v.parse(updateTaskValibotSchema, { title: "Updated" });
...
export function testUpdateTaskOmittableArchivedAcceptsValue() {
  const validated = v.parse(updateTaskValibotSchema, { isArchived: true });
