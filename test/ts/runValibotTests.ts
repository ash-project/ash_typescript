...
// Runtime test runner for Valibot constraint validation
...
console.log("\n========================================");
console.log("Running Valibot Constraint Validation Tests");
console.log("========================================\n");
...
if (failed > 0) {
  ...
  console.log("\n✓ All Valibot constraint validation tests passed!");
}
