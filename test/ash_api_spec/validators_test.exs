...
defmodule AshApiSpec.ValidatorsTest.MixedAcceptResource do
  @moduledoc false
...
defmodule AshApiSpec.ValidatorsTest do
  use ExUnit.Case, async: true

  alias AshApiSpec.Validators
  alias AshApiSpec.ValidatorsTest.MixedAcceptResource
  ...
  describe "validate_accept_public/2" do
    ...
    test "works with %AshApiSpec.Action{}-shaped maps" do
