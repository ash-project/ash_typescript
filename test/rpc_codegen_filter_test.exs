defmodule AshTypescript.RPC.CodegenFilterTest do
  ...
  defmodule TestPost do
    use Ash.Resource,
      ...
      domain: AshTypescript.RPC.CodegenFilterTest.Domain
  ...
  defmodule Domain do
    ...
    resources do
      resource AshTypescript.RPC.CodegenFilterTest.TestPost
    end
  end
  ...
  describe "generate_input_type/4 filter field inclusion" do
    ...
    test "create actions with arguments do not include filter field" do
      ...
      result =
        Codegen.generate_input_type(action, "TestCreateWithArgsInput", primary_key, resource)

      refute String.contains?(result, "filter?")
      refute String.contains?(result, "FilterInput")
      # should have the argument
      assert String.contains?(result, "auto_publish")
      # should have accepted fields
    ...
    test "update actions with arguments do not include filter field" do
      ...
      refute String.contains?(result, "FilterInput")
      # should have the argument
      assert String.contains?(result, "publish_date")
    end
    ...
    test "generic actions do not include filter field" do
      ...
      refute String.contains?(result, "FilterInput")
      # should have the argument
      assert String.contains?(result, "include_drafts")
    end
    ...
    test "filter field type name matches resource name" do
      ...
      assert String.contains?(result, "filter?: TestPostFilterInput;")
      # should not use generic name
      refute String.contains?(result, "filter?: FilterInput;")
    end
  ...
  describe "edge cases" do
    ...
    test "filter field format is correct" do
      ...
      assert String.contains?(result, "filter?: TestPostFilterInput;")
      # should be optional
      refute String.contains?(result, "filter: TestPostFilterInput;")
      # should have space
      refute String.contains?(result, "filter?:TestPostFilterInput;")
    end
  end
