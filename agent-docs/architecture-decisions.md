...
- `lib/ash_typescript/codegen/` - focused modules (type_discovery, type_aliases, type_mapper, resource_schemas, helpers, filter_types); reachability in `lib/ash_api_spec/generator/reachability.ex`
