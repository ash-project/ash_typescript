        ...
        case metadata_type do
          :field_selectable_resource ->
            ...
            if Enum.empty?(calc.arguments) do
              "{ __type: \"FieldSelectableCalculation\"; __resource: #{resource_type}; }"
            else
              args_type = generate_calculation_args_type(calc.arguments)

              "{ __type: \"FieldSelectableCalculation\"; __resource: #{resource_type}; __args: #{args_type}; }"
            end

          :field_selectable_array ->
            # Array of resources, treat like has_many relationship
            if Enum.empty?(calc.arguments) do
              "{ __type: \"FieldSelectableCalculation\"; __array: true; __resource: #{resource_type}; }"
            else
              args_type = generate_calculation_args_type(calc.arguments)

              "{ __type: \"FieldSelectableCalculation\"; __array: true; __resource: #{resource_type}; __args: #{args_type}; }"
            end
