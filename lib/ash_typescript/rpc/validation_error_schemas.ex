...
defmodule AshTypescript.Rpc.ValidationErrorSchemas do
  ...
  def generate_validation_error_schemas_for_typed_structs(type_infos) when is_list(type_infos) do
    if type_infos != [] do
      # Handle both new format (maps) and legacy format (modules)
      schemas =
        type_infos
        |> Enum.map_join("\n\n", fn
  ...
  # Generates validation error schema for a type with field constraints
  # Uses provided constraints and field_name_mappings instead of introspecting the module
