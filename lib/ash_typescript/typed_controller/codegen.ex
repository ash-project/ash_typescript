...
defmodule AshTypescript.TypedController.Codegen do
  ...
  def generate_controller_content(opts) do
    ...
    if routes_config == [] do
      ...
      generate_typescript_with_imports(route_infos, import_paths, shared_type_names)
    end
  end
  ...
  defp generate_typescript_with_imports(route_infos, import_paths, shared_type_names) do
    header = """
