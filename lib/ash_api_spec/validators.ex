...
defmodule AshApiSpec.Error.NonPublicAccept do
  @moduledoc """
  Raised by `AshApiSpec.Generator` when an action entrypoint's accept list
...
defmodule AshApiSpec.Validators do
  @moduledoc """
  ...
  @doc """
  Raises `AshApiSpec.Error.NonPublicAccept` if `action`'s accept list contains
  any non-public attributes on `resource`. Used by `AshApiSpec.Generator` to
